...
func (m *apt) manageRepository(repoAction shared.DefinitionPackagesRepository) error {
	...
	// Truncate file if it's not generated by lxd-imagebuilder
	if !strings.HasPrefix(string(content), "# Generated by lxd-imagebuilder\n") {
		err = f.Truncate(0)
		if err != nil {
		...
		_, err = f.WriteString("# Generated by lxd-imagebuilder\n")
		if err != nil {
